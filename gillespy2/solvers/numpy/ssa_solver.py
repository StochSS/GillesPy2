...
class NumPySSASolver(GillesPySolver):
    ...
    @classmethod
    def run(self, model, t=20, number_of_trajectories=1, increment=0.05, seed=None, debug=False, show_labels=True,display_type = None, **kwargs):
        """
                ...
                try:
                    ...
                    if display_type == "text":
                        ...
                        for i in range(number_species):
                            print(str(curr_state[i])[:10].ljust(10), end="|")
                        print("")
